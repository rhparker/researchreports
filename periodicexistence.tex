...
a_0 &= \exp \left( -\frac{1}{\rho} \arctan \rho - n \pi \right) && n \in \Z
\end{align*}
...
\begin{equation}
b^*_n = \exp \left( -\frac{1}{\rho} \arctan \rho - n \pi \right) 
...
&= \frac{2 \rho}{b_n^*} (-1)^n \sqrt{1 + \rho^2}
\end{align*}

Since $\rho > 0$, this is nonzero. Let $k_1 = f_{xy}(0, b^*_n)$. \\

Finally, we check the third derivative with respect to $x$. This is a mess, but from Mathematica we have
