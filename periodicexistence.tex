...
\item For this value of $r_m$, using Lemma \ref{zeropersists} with interval $I_0 = [0, b^* - \epsilon_0/2]$, there exists a unique function $h: I_0 \times \mathcal{R} \cap [0, r] \rightarrow \R$ such that
...
\begin{proposition}
There exists $r > 0$ such that for $r_m < r$, there exists a 1-paramater family of 2-periodic solution, paramaterized by $a_1$. The ``length paramaters'' of the 2-periodic solution are given by
