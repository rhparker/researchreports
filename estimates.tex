...
\[
||L_2(\lambda)(a, b, d)(x)||_\eta \leq C(e^{\eta X}|a| + |b| + |\lambda|^2 |d|)
\]

where $X$ is the maximum of the join points $X_i$ which are finite.
...
Substituting $W_1(\lambda)(a,b,d)$ from Lemma \ref{W1} into this, we have the following equation
...
This is linear in $(a,b,d)$ and analytic in $\lambda$. Now we will get a bound on $L_3(\lambda)$. First, let
