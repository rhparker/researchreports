...
If we substitute $W = W_1(\lambda)(a,b,d)$ from Lemma \ref{W1}, this is linear in $(a,b,d)$ and analytic in $\lambda$. Now we will get a bound on $L_3(\lambda)$. First, let
...
&= C \left( p(L) + |G| + \frac{|\lambda|}{\eta}\right)|a| + C \left[ e^{-\alpha L} + e^{-\eta L} \left(|G| + \frac{|\lambda|}{\eta}\right) \right] |b| + \left(|G| + \frac{\lambda}{\eta}\right)(|a| + e^{-\eta L}|b| \\
