...
Choose length parameters $b_0^0, \dots, b_{n-1}^0$ and phase parameter $\theta$. Then there exists $r_\epsilon \leq r_0$ such that for $r \leq r_\epsilon$, the $\epsilon-$ball condition is satisfied.
\end{lemma} 
