...
Since the same must be true of $q_{2c}$, and $(q_{2c})i^\pm = q_c + r_{ic}^\pm$, we must have
...
&\leq C \left[ (e^{-\alpha L} + |G|) |\lambda|^2 + (e^{-(\alpha + \eta)L} + |G|)(e^{-\alpha L} + |G| + |\lambda|)|D_1^\eta| + |\lambda|^3 + |\lambda| (e^{-\alpha L} + |G| + |\lambda|)|D_1^\eta| \right]|d|\\
\end{align*}
...
\begin{align*}
|(R(\lambda)d)_1| &\leq C [ (e^{-\alpha L} + |G|) |\lambda|^2 + (e^{-(\alpha + \eta)L} + |G|)(e^{-\alpha L} + |G| + |\lambda|)e^{-(\alpha - \eta)L} \\
&+|\lambda|^3 + |\lambda| (e^{-\alpha L} + |G| + |\lambda|) e^{-(\alpha - \eta)L} ] |d| \\
&=C [ (e^{-\alpha L} + |G|) |\lambda|^2 + (e^{-(\alpha + \eta)L} + |G|)(e^{-\alpha L} + |G| + |\lambda|)e^{-(\alpha - \eta)L} \\
&+|\lambda|^3 + |\lambda| (e^{-\alpha L} + |G| + |\lambda|) e^{-(\alpha - \eta)L} ] |d|
\end{align*}
