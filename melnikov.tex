...
\item For the terms involving $K_1^\pm B (R_1^\pm)_c$, we know that $q_c$ is differentiable in $c$ and that the derivative $q_c$ is exponentially decaying, thus this thing should also be small and exponentially decaying. I am not sure what the best bound for it is, but it should also wind up in the remainder term and we won't worry about it for now.
