...
For $c$ near $c_0$, the transverse intersection of manifolds is preserved. Thus we still have a single-pulse (homoclinic orbit) for $c$ near $c_0$.
\begin{proof}
This will use either stuff from differential topology or the implicit function theorem. 
\end{proof}
\end{lemma}
