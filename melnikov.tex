...
&d_i A(Q_2)Q_2' - d_i \lambda A(Q_2)Q_{2c} + \lambda^2 A(Q_2) W_i^\pm + d_i \lambda KBQ_2' - d_i \lambda^2KBQ_{2c} + \lambda^3 K_i^\pm B W_i^\pm 
\end{align*}
...
&+ \int_{-X_{i-1}}^x \Phi^s_-(x, y)[\lambda K_i^- BW_i^- - d_i KBQ_{c} + G_i^- W_i^- - d_i K_i^- B (R_i^-)_c ] dy \\
W_i^+(x) = \Phi^u_+(&x, X_i)a_i^+ + \Phi^s_+(x, 0)b_i^+ \\
&+ \int_0^x \Phi^s_+(x, y)[\lambda K_i^+ BW_i^+ - d_i KBQ_{c} + G_i^+ W_i^+ - d_i K_i^+ B (R_i^+)_c ] dy \\
&+ \int_{X_i}^x \Phi^u_+(x, y)[\lambda K_i^+ BW_i^+ - d_i KBQ_{c} + G_i^+ W_i^+ - d_i K_i^+ B (R_i^+)_c ]dy
\end{align*}
...
&-\left( \int_{-X_{i-1}}^0 \langle \Psi(y), d_i (K B Q_c)(y) \rangle dy - \int_{X_i}^0 \langle \Psi(y), d_i (K B Q_c)(y) \rangle dy \right) \\
&+\left( \int_{-X_{i-1}}^0 \langle \Psi(y), G_i^- W_i^-(y) - d_i (K_i^- B (R_i^-)_c)(y) \rangle dy - \int_{X_i}^0 \langle \Psi(y), G_i^+ W_i^+(y) - d_i (K_i^+ B (R_i^+)_c)(y) \rangle dy \right) \\
