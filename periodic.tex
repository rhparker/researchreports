...
We can now estimate the ``noncenter'' integrals which do not involve $H$. 
...
+ |\lambda|^2 + e^{-\tilde{\alpha} X_1} |D| ) |d| dy \\
...
Now we take a look at the ``noncenter'' integrals involving $H$. These will give us our higher order Melnikov integral.
