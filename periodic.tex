...
\begin{align*}
|Q^\pm(0, \beta_i^\pm)(0) - Q(0)| \leq 
C \left( e^{-\alpha X_1} + e^{-\alpha X_2} \right)
\end{align*}

although we should not need these.
...
Note that the bound is strongest at $x = 0$ and is weaker at $\pm X_i$. 
...
Since $a_i^- - a_i^+ \in E^+ \oplus E^-$, the RHS must lie in $E^+ \oplus E^-$ as well. Since $\C^5 = E^+ \oplus E^- \oplus E^0$, the RHS must have no component in the (unperturbed) center space. The vectors $v_\pm(\pm X_i; \lambda)$ are close to $v_0(\lambda)$, which is close to $v_0(0) \in E^0$. Define
...
&+ e^{-\tilde{\alpha} X_1} |D||d| + |\lambda|^2|d|
\Big)
\end{align*}
...
\begin{align*}
|L_4&(\lambda)_i(b, c, d)| \leq C \delta (|b| + |\tilde{c}|) + C ( e^{-\tilde{\alpha} X_1} |D|+ |\lambda|^2)|d|
\end{align*}
...
&+ \int_{X_i}^0 \Phi^u_+(0, y; \lambda) [ G_i^+(y)W_i^+(y) + \lambda^2 d_i \tilde{H}(y) ] dy \\
&+ \int_{X_i}^0 e^{-\nu(\lambda)y} v_+(0; \lambda) \langle G_i^+(y)(y)W_i^+(y) + \lambda^2 d_i \tilde{H}(y), w_+(y; \lambda) \rangle dy \\
&- \int_{-X_{i-1}}^0 \Phi^s_-(0, y; \lambda) [ G_i^-(y)W_i^-(y) + \lambda^2 d_i \tilde{H}(y) ] dy \\
&- \int_{-X_{i-1}}^0
e^{\nu(\lambda)y} v_-(0; \lambda) \langle G_i^-(y)(y)W_i^-(y) + \lambda^2 d_i \tilde{H}(y), w_-(y; \lambda) \rangle dy \\
\end{align*}
...
&+ \mathcal{O}\Big(e^{-\tilde{\alpha} X_1}(|\lambda|^2 
...
\begin{align*}
\langle \Psi(0), &\Phi^u_+(0, X_i; \lambda) a_i^+ \rangle \\
&= \langle \Psi(X_i), P^u_0 D_i d \rangle + \mathcal{O}\Big(e^{-\alpha X_i} \Big( |\lambda|^2  + (p_1(X_i; \lambda) + e^{-\tilde{\alpha} X_1} + ||G|| + |\lambda|)|D| \Big)|d| \Big)
\end{align*}
...
+ \mathcal{O}\Big(e^{-\alpha X_{i-1}} \Big( |\lambda|^2  + (p_1(X_{i-1}; \lambda) + e^{-\tilde{\alpha} X_1}  + ||G|| + |\lambda|)|D| \Big)|d| \Big)
\end{align*}
...
&= -d_i \lambda^2 \int_{-\infty}^\infty \langle \Psi(y), H(y) \rangle dy + \mathcal{O}\left( (|\lambda| + e^{-\alpha X_i} + e^{-\alpha X_{i-1}} ) |\lambda|^2 |d| \right)
\end{align*}
...
\left| \Psi(0), \int_{X_i}^0 e^{-\nu(\lambda)y} v_+(0; \lambda) \langle G_i^+(y)W_i^+(y), w_+(y; \lambda) \rangle dy  \right| &\leq C \Big( e^{-\tilde{\alpha} X_1} |\lambda|^3 + e^{-\tilde{\alpha} X_1} |\lambda| |D| \Big) |d|
\end{align*}
...
&= \int_{-X_{i-1}}^0
e^{\nu(\lambda)y} \langle \Psi(0), v_-(0; \lambda) \rangle \langle G_i^-(y)W_i^-(y), w_-(y; \lambda) \rangle dy \\
