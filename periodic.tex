...
\begin{hypothesis}
\begin{enumerate}
	\item $U = 0$ is a hyperbolic equilibrium, i.e. we can find $\alpha > 0$ such that the real part of the spectrum of $D_U F(0)$ lies outside of $(-\alpha, \alpha)$.
	\item $D_U F(0)$ has two stable and two unstable directions.
