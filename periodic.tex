...
\begin{proof}
We know that $Q'(0) = F(Q(0)) \neq 0$, i.e. the center of the pulse is not an equilibrium of the vector field $F$. Recall that 
...
Their one-dimensional intersection is the homoclinic orbit $Q(x) = \Psi(x; 0, 0, 0)$, whose tangent space is $Q'(x)$.\\
