...
\[
|A_1(\lambda)(b, c^-)| \leq C ( (e^{-\alpha T} + |G|)|b| + p_2(T; \lambda)|c^-| + |\lambda^2|)
\]

We can plug this into our expression for $W_1$ to get $W_2(\lambda)$ which has bound

\begin{align*}
||W_2(\lambda)(b, c^-)|| &\leq C ((e^{-\alpha T} + |G|)|b| + p_2(T; \lambda)|c^-| + |\lambda^2|+ |b| + e^{\nu(\lambda)T}(|c^-| + |\Delta c|) |\lambda|^2) \\
&\leq C (|b| + p_2(T; \lambda)|c^-| + e^{\nu(\lambda)T}|\Delta c| + e^{\nu(\lambda)T}|c^-| + \lambda|^2) \\
&\leq C (|b| + e^{\nu(\lambda)T}((e^{-\alpha T} + |G|)|b| + p_2(T; \lambda)|c^-| + |\lambda^2|) + e^{\nu(\lambda)T}|c^-| + |\lambda|^2) \\
&\leq C (|b| + e^{\nu(\lambda)T}|c^-| + |\lambda|^2)
\end{align*}
