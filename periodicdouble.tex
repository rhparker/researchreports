...
Now we plug in our estimate for $|c_2^|$. Recall that this is of order $e^{-|\nu(\lambda)|k X_1} B_1(\lambda(d)|_2$. Thus we have

\begin{align*}
|&e^{\nu(\lambda)k X_1} c_2^- \langle v_0(\lambda), w_-(-k X_1; \lambda) \rangle \langle \Psi(0), v_-(0; \lambda) \rangle| \\
&\leq C e^{\nu(\lambda)k X_1} e^{-|\nu(\lambda)|k X_1} (|\lambda^2| + e^{\nu(\lambda)k X_1}|D_1|)|d| (|\lambda| + \mathcal{O}(\lambda^2) ) \\
&\leq C (|\lambda|^3 + |\lambda| e^{\nu(\lambda)k X_1}|D_1|)|d|
\end{align*}
